...
> Full-stack marketplace connecting customers with independent artisans — product discovery, social following, secure ordering, and AI-powered recommendations.
...
> Secure ASP.NET Core MVC platform for managing medical practice operations — role-based access (Admin, Doctor, Secretary, Patient), KPI dashboards, and patient workflow management.
...
### 🥗 [NutriSafe Website](https://github.com/MsdAmine/nutrisafe_website) · [Live ↗](https://nutrisafe-website.vercel.app)
> Production-ready Next.js landing page for an AI-powered food safety app — animated UI, full SEO (metadata, JSON-LD, sitemap, robots), deployed on Vercel.
...
### 🤝 [FreelancerHub](https://github.com/ME-Massine/FreelanceHub)
> Django-based platform for managing client-freelancer interactions through a structured portal.
...
Open to collaborations, internships, and interesting projects. Feel free to reach out!
